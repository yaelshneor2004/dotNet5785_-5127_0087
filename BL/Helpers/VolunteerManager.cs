...
private static bool IsValidEmail(string email)
   ...
   private static bool IsValidPhoneNumber(string phoneNumber)
    ...
    public static double GlobalDistance(double? lat1, double? lon1, double lat2, double lon2,BO.MyTypeDistance myTypeDistance)
    {
            if (lat1 == null || lon1 == null)
               throw new BlInvalidOperationException("Latitude and Longitude cannot be null.");
                return myTypeDistance switch
        {
            BO.MyTypeDistance.Aerial => CalculateAerialDistance(lat1.Value, lon1.Value, lat2, lon2),
            MyTypeDistance.Walking => CalculateWalkingDistance(lat1.Value, lon1.Value, lat2, lon2),
            MyTypeDistance.Traveling => CalculateDrivingDistance(lat1.Value, lon1.Value, lat2, lon2),
